...
extension Mailgun.Domains.Domains.Tracking {
    ...
    public enum API: Equatable, Sendable {
        ...
        case updateClick(domain: TypesFoundation.Domain, request: Mailgun.Domains.Domains.Tracking.UpdateClick.Request)
        case updateOpen(domain: TypesFoundation.Domain, request: Mailgun.Domains.Domains.Tracking.UpdateOpen.Request)
        case updateUnsubscribe(domain: TypesFoundation.Domain, request: Mailgun.Domains.Domains.Tracking.UpdateUnsubscribe.Request)
    }
}
        ...
        public var body: some URLRouting.Router<Mailgun.Domains.Domains.Tracking.API> {
            OneOf {
                ...
                URLRouting.Route(.case(Mailgun.Domains.Domains.Tracking.API.updateUnsubscribe)) {
                    ...
                    Path { "tracking" }
                    Path { "unsubscribe" }
                    Body(.form(Mailgun.Domains.Domains.Tracking.UpdateUnsubscribe.Request.self, decoder: .mailgun, encoder: .mailgun))
                }
            }
        }
    }
