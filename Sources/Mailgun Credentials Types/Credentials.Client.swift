...
extension Mailgun.Credentials {
  ...
  public struct Client: Sendable {
    ...
    @DependencyEndpoint
    public var update:
      @Sendable (_ domain: Domain, _ login: String, _ request: Mailgun.Credentials.Update.Request)
    ...
    public var updateMailbox:
      @Sendable (
        _ domain: Domain, _ login: String, _ request: Mailgun.Credentials.Mailbox.Update.Request
