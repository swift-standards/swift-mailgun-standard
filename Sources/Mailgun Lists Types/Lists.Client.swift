...
extension Mailgun.Lists {
  ...
  public struct Client: Sendable {
    ...
    @DependencyEndpoint
    public var list:
      @Sendable (_ request: Mailgun.Lists.List.Request) async throws -> Mailgun.Lists.List.Response
    ...
    @DependencyEndpoint
    public var delete:
      @Sendable (_ listAddress: EmailAddress) async throws -> Mailgun.Lists.List.Delete.Response
    ...
    public var memberPages:
      @Sendable (_ listAddress: EmailAddress, _ request: Mailgun.Lists.List.Members.Pages.Request)
