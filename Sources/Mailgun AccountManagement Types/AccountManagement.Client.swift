...
extension Mailgun.AccountManagement {
  ...
  public struct Client: Sendable {
    ...
    public var regenerateHttpSigningKey:
      @Sendable () async throws -> Mailgun.AccountManagement.HttpSigningKey.Regenerate.Response

    @DependencyEndpoint
    public var getSandboxAuthRecipients:
      @Sendable () async throws -> Mailgun.AccountManagement.Sandbox.Auth.Recipients.List.Response
    ...
    public var addSAMLOrganization:
      @Sendable (_ request: Mailgun.AccountManagement.SAML.Organization.Add.Request) async throws ->
