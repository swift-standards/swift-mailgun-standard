...
extension Mailgun.Templates {
  ...
  public struct Client: Sendable {
    ...
    @DependencyEndpoint
    public var get:
      @Sendable (_ templateName: String, _ request: Mailgun.Templates.Get.Request?) async throws ->
        Mailgun.Templates.Get.Response

    @DependencyEndpoint
    public var update:
      @Sendable (_ templateName: String, _ request: Mailgun.Templates.Update.Request) async throws
